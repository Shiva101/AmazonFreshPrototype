...
cnn.queue('adminBilling_queue', function(q){
        ...
        q.subscribe(function(message, headers, deliveryInfo, m){
            ...
            switch (message.func) {
                case "getBillingList":
                    admin.handle_request_getBillingList(message, function(err,res){
                        util.log("Correlation ID: " + m.correlationId);
                        // return index sent
                        cnn.publish(m.replyTo, res, {
                            contentType: 'application/json',
                ...
                break;
                case "getBillingSearchList":
                    admin.handle_request_getBillingSearchList(message, function(err,res){
                        util.log("Correlation ID: " + m.correlationId);
                        // return index sent
                        cnn.publish(m.replyTo, res, {
                            contentType: 'application/json',
